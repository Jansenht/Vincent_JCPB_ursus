...
h37 = subset(gene_level_norm_counts_copy, ...1 %in% matchedh37$CycID)
write.csv(h37, "Desktop/for_mfuzz_h37.csv")
...
tmp =  tempfile()
write.table(h37,file=tmp, sep='\t', quote = F, col.names=NA)
...
h37_cluster_matrix = cor(t(c[[1]]))

write.csv(h37_cluster_matrix, "Desktop/h37_cluster_matrix.csv")
...
write.csv(acore_list, "Desktop/h37_mfuzz_genelist_acore.csv")
